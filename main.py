...
def draw_random_write(file='./log_files/motivation.txt'):
    ...
    for i in range(len(data['label'])):
        for j, key in enumerate(normalized_data.keys()):
            ...
            if normalized_data[key][i] > threshold:
                axlog.text(index[i]+j*bar_width, normalized_data[key][i]*1.2, text, fontsize=BIG_SIZE, rotation=0,
                           ha='center')
            else:
                ax.text(index[i]+j*bar_width, normalized_data[key][i]+0.01, text, fontsize=BIG_SIZE, rotation=0,
                        ha='center')
    ...
    # plt title
    plt.suptitle('Random Write Micro Benchmark', fontsize=BIGGER_SIZE, fontweight='bold')
    plt.tight_layout()
    # plt.show()
    plt.savefig('./figures/random_write.png')
...
def draw_random_read(file='./log_files/motivation.txt'):
    ...
    # plt title
    plt.suptitle('Random Read Micro Benchmark', fontsize=BIGGER_SIZE, fontweight='bold')
    plt.tight_layout()
    # plt.show()
    plt.savefig('./figures/random_read.png')
...
def draw_seq_read(file='./log_files/motivation.txt'):
    ...
    # plt title
    plt.suptitle('Sequential Read Micro Benchmark', fontsize=BIGGER_SIZE, fontweight='bold')
    plt.tight_layout()
    # plt.show()
    plt.savefig('./figures/sequential_read.png')
...
def draw_seq_write(file='./log_files/motivation.txt'):
    ...
    # plt title
    plt.suptitle('Sequential Write Micro Benchmark', fontsize=BIGGER_SIZE, fontweight='bold')
    plt.tight_layout()
    # plt.show()
    plt.savefig('./figures/sequential_write.png')
